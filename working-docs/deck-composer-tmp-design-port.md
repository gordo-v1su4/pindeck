# DeckComposer TMP Design Port Plan

This document is the source-controlled handoff for the TMP design-port work. It mirrors the local OMX plan artifacts without committing `.omx/` runtime state.

## Source artifacts

- PRD source: `.omx/plans/prd-deck-composer-tmp-design-port.md`
- Test spec source: `.omx/plans/test-spec-deck-composer-tmp-design-port.md`
- Context source: `.omx/context/deck-composer-tmp-design-port-20260423T084320Z.md`
- Visual/code reference: `TMP/redesign/deck.jsx`
- Supporting TMP files: `TMP/redesign/HANDOFF.md`, `TMP/redesign/decks-gallery.jsx`, `TMP/redesign/parts.jsx`, TMP screenshots

> `.omx/` is intentionally excluded from git. This file captures the durable plan in a tracked location.
