...
<Info>
The old duplicate Vercel project `pindeck-754f` was removed on June 15, 2026. Current deploys and status contexts should come only from the `pindeck` project.
</Info>
