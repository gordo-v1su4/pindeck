...
| Field | Description |
| --- | --- |
| `imageUrl` | Public URL that Pindeck can download and copy into RustFS. |
...
| `importBatchId` | Optional Convex import batch id, if the integration has already created one. Omit for simple external automations. |
